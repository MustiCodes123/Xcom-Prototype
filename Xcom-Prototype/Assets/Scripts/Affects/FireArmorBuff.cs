...
public class FireArmorBuff : BaseBuff
{
    private List<BaseCharacerView> _attackers = new List<BaseCharacerView>();
    public FireArmorBuff(BaseParticleView.Factory particleFactory, BaseSkillModel skill)
    {
        _skill = skill;
    ...
    private void Damage(BaseCharacerView attacker)
    {
        ...
        BurnDebuff burn = new BurnDebuff(_particleFactory, _skill);
