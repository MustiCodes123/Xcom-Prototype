...
public class IceArrowTalentBehaviour: BaseSkillBehaviour
{
    private UnityEngine.Vector3 _arrowOfset = new UnityEngine.Vector3(0, 1, -1);
    public IceArrowTalentBehaviour(BaseSkillModel skill, BaseParticleView.Factory particleFactory, CharactersRegistry charactersRegistry, BaseProjectile.Factory projectileFactory, BaseDecale.Factory decaleFactory) : base(skill, particleFactory, charactersRegistry)
    {
    ...
    public void OnHit()
    {
        ...
        var frostBuff = GetBuff(Skill.OnCollisionBuff);
        _target.SkillServiceProvider.AddBuff(frostBuff);
